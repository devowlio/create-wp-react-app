 ...
 * @returns
 */
function applyPromptsToTemplates(rootName, createPluginCwd, templates, input) {
    ...
    utils_1.logSuccess("Successfully created readme file for wordpress.org " + chalk_1.default.underline(readmeTxtFile));
    return {
