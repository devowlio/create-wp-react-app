...
/**
 * Apply the slug to different files where needed. Also apply
 * the main root slug in the plugin so the utils package for example can
 * be correctly linked and resolved.
 *
 * @param workspace
