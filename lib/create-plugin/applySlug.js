...
function applySlug(workspace, createPluginCwd, slug) {
    ...
    var multiStarterFiles = __spreadArrays(globFiles("src/public/ts/**/*.tsx"), globFiles("{composer,package}.json"), globFiles("composer.lock"));
    ...
    fs_1.renameSync(path_1.resolve(phpPotFolder, "wp-reactjs-starter.pot"), path_1.resolve(phpPotFolder, slug + ".pot"));
