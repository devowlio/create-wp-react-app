...
function copyTemplates(createPluginCwd) {
    ...
    var templates = {
        "index.php": fs_1.readFileSync(path_1.resolve(templateCwd, "../grunt-index-php.tmpl"), { encoding: utils_1.DEFAULT_ENCODING }),
    ...
    rimraf_1.default.sync(path_1.resolve(createPluginCwd, "src/languages"));
    rimraf_1.default.sync(path_1.resolve(createPluginCwd, "src/public/languages"));
