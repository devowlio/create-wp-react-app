...
var _1 = require("./");
var createPluginCommand = commander_1.command("create-plugin")
    ...
    .option("--min-php <value>", "What's the minimum required PHP version (minimum of 7.0 required for the boilerplate)?")
    .option("--min-wp <value>", "What's the minimum required WordPress version (minimum of 5.2 required for the boilerplate)?")
    ...
    .action(function (args) { return _1.createPluginPrompt(args); });
