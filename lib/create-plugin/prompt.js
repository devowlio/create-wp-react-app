    ...
    inquirer_1
        ...
        .then(function(answers) {
            return __awaiter(_this, void 0, void 0, function() {
                var parsed, root, createPluginCwd, e_1;
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            try {
                                ...
                                if (
                                    !fs_1.existsSync(
                                        path_1.resolve(createWorkspaceCwd, utils_1.FOLDER_CWRA, "template")
                                    )
                                ) {
                                    throw new Error(
                                        "The template folder in common/create-wp-react-app could not be found!"
                                    );
                                }
                            } catch (e) {
                            ...
                            createPluginCwd = _1.createPluginExecute(root, parsed, !!before);
