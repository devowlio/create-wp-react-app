 ...
 *
 * @param opts
 * @param cb If you pass a callback the plugin itself will not be installed and build because it comes from create-workspace
 */
function createPluginPrompt(_a, cb) {
    var _this = this;
    var cwd = _a.cwd,
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, _1.createPluginExecute(root, parsed, !!cb)];
                        case 1:
                            _a.sent();
                            cb && cb();
                            return [3 /*break*/, 3];
