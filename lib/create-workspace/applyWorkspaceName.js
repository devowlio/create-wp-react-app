...
function applyWorkspaceName(workspace, createCwd) {
    ...
    var globFiles = function (pattern) { return glob_1.default.sync(pattern, { cwd: createCwd, absolute: true }); };
    var workspaceFiles = __spreadArrays(globFiles(".gitlab-ci.yml"), globFiles("package.json"), globFiles("{plugins,packages}/*/package.json"));
