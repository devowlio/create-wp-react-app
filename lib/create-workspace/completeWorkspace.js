            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (gitlabProject) {
                        ...
                        execa_1.default.sync("git", ["commit", "-m 'chore: initial commit'"], { cwd: createWorkspaceCwd, stdio: "inherit" });
                    ...
                    return [4 /*yield*/, inquirer_1.prompt(create_plugin_1.PROMPT_AFTER_BOOTSTRAP)];
                case 1:
                    answers = _a.sent();
