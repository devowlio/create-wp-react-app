...
function createGitFolder(checkout, repository, createCwd, gitlabProject) {
    ...
    utils_1.logProgress(
        "Download repository " +
            chalk_1.default.underline(repository) +
            " ref " +
            chalk_1.default.underline(checkout) +
            "..."
    );
    ...
    if (gitlabProject) {
        ...
        utils_1.logProgress(
            "Initialize into new repository " + chalk_1.default.underline(gitlabProject.ssh_url_to_repo) + "..."
        );
