...
function createWorkspaceExecute(input) {
    return __awaiter(this, void 0, void 0, function () {
        var createCwd, gitlabProjectCreator, gitLabProject;
        var _this = this;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        _1.applyPhpUtils(pluginData.namespace, createPluginCwd);
                                        ...
                                        // Complete
                                        return [4 /*yield*/, _1.completeWorkspace(createPluginCwd, createCwd, input, gitLabProject)];
                                    case 1:
                                        // Complete
                                        _a.sent();
                                        return [2 /*return*/];
