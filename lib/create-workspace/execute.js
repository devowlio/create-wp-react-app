...
function createWorkspaceExecute(input) {
    var _this = this;
    var createCwd = path_1.resolve(process.cwd(), input.workspace);
    console.log(
    ...
    create_plugin_1.createPluginPrompt(
        ...
        function() {
            return __awaiter(_this, void 0, void 0, function() {
                return __generator(this, function(_a) {
                    _1.createGitFolder(input.checkout, input.repository, input.workspace, createCwd);
        ...
        function(createPluginCwd, pluginData) {
            return __awaiter(_this, void 0, void 0, function() {
                return __generator(this, function(_a) {
                    return [2 /*return*/, _1.completeWorkspace(createPluginCwd, pluginData, createCwd, input)];
                });
            });
        }
    );
