...
var promptGitLab_1 = require("./promptGitLab");
/**
...
function createWorkspaceExecute(input) {
    return __awaiter(this, void 0, void 0, function() {
        var createCwd, gitlabProjectResult, gitlabProject;
        var _this = this;
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    createCwd = path_1.resolve(process.cwd(), input.workspace);
                    return [4 /*yield*/, promptGitLab_1.promptGitLab(input.workspace)];
                case 1:
                    gitlabProjectResult = _a.sent();
                    gitlabProject = gitlabProjectResult === false ? undefined : gitlabProjectResult;
