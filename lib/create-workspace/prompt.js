...
function createWorkspacePrompt(_a) {
    var workspace = _a.workspace, repository = _a.repository, checkout = _a.checkout, remote = _a.remote, portWp = _a.portWp, portPma = _a.portPma;
    return __awaiter(this, void 0, void 0, function () {
        var mockData, answers, _b, parsed, e_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, _1.checkDependencies()];
                case 1:
                    _c.sent();
                    ...
                    return [4 /*yield*/, inquirer_1.prompt([
                            ...
                            !remote && {
                                name: "remote",
                                message: utils_1.getCommandDescriptionForPrompt(_1.createWorkspaceCommand, "--remote"),
                                type: "input",
                                validate: function (value) {
                                    return !value ? true : utils_1.isValidUrl(value, true);
                                }
                            },
                            !portWp && {
                                name: "portWp",
                                ...
                                default: function (answers) {
                                    var useRemote = answers.remote || remote;
                                    if (useRemote) {
                ...
                case 4:
                    _c.trys.push([4, 6, , 7]);
                    parsed = __assign({ workspace: workspace, repository: repository, checkout: checkout, remote: remote, portWp: portWp, portPma: portPma }, answers);
