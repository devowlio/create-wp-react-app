                        ...
                        inquirer_1.prompt([
                            {
                                ...
                                validate: function(value) {
                                    return utils_1.isValidUrl(value, true);
                                }
                            },
                            {
                                name: "token",
                                ...
                                message:
                                    ...
                                    " (click the link to learn how to obtain a token; create with " +
                                    chalk_1.default.underline("api") +
                                    " scope)?",
                            ...
                            return __generator(this, function(_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        utils_1.logSuccess(
                                            "Successfully created project " +
                                                chalk_1.default.underline(project.name_with_namespace)
                                        );
                                    ...
                                    case 2:
                                        ...
                                        return [
                                            4 /*yield*/,
                                            api_1.Projects.edit(project.id, {
                                    ...
                                    case 3:
                                        _a.sent();
                                        utils_1.logSuccess(
                                            "Successfully created default branch " +
                                                chalk_1.default.underline("develop")
                                        );
