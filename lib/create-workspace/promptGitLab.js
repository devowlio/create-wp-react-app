                ...
                case 1:
                    ...
                    return [4 /*yield*/, inquirer_1.prompt([
                            ...
                            },
                            {
                                name: "token",
                                type: "input",
                                message: "What's your " + terminal_link_1.default("personal token", "https://docs.gitlab.com/ee/user/profile/personal_access_tokens.html") + " (click the link to learn how to obtain a token; create with " + chalk_1.default.underline("api") + " scope)?",
