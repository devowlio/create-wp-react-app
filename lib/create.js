    	    ...
    	    task: (ctx, headTask) => new Listr([{
    	        ...
    	        task: () => {
					...
					let replaceBottle = [{ // Slug relevant
						files: globFiles('inc/general/Assets.class.php' /* legacy */).concat(pluginFileList.docker, pluginFileList.pkg, globFiles('.gitlab-ci.yml')),
						...
						files: globFiles('inc/rest/Service.class.php').concat(pluginFileList.tsx).concat(pluginFileList.pkg),
						search: /wprjss\/v1/g,
