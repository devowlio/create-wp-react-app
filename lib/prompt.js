...
exports.listr = (pluginCwd, dry, _skip, _passedPrompts) => ({
    ...
    task: () => {
        ...
        const task = new Listr([
            ...
            createInputTask({ name: 'Minimum PHP version (minimum of 5.4 required for the boilerplate)', key: 'minPHP', defaultValue: '5.4.0' }),
            createInputTask({ name: 'Minimum WordPress version (minimum of 5.0 required for the boilerplate)', key: 'minWP', defaultValue: '5.0.0' }),
