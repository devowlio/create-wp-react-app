...
abstract class Assets extends Base {
     ...
     * src is not found in the cachebuster (inc/base/others/cachebuster.php) it falls back to WPRJSS_VERSION.
     *
     ...
     * @return string WPRJSS_VERSION or cachebuster timestamp
     */
    public function getCachebusterVersion($src, $isLib = false) {
        $default = WPRJSS_VERSION;
        $path = WPRJSS_INC . '/base/others/';
